...
\small
\begin{itemize}
\item Selection of four pilot viral species
\item Overview of annotation pipeline
\item Explanation of ``error codes''
\item Statistics on pilot phase annotations
\item Examples of ``error codes''
\item Implementation of annotation pipeline
\item Interaction with Rodney's Virus Variation group
...
\small
\begin{itemize}
\item \textcolor{blue}{Selection of four pilot viral species}
\item Overview of annotation pipeline
\item Explanation of ``error codes''
\item Statistics on pilot phase annotations
\item Examples of ``error codes''
...
\small
\begin{itemize}
\item Per-feature errors:
\begin{itemize}
\item unexpected stop codon-related errors (trc, ntr, ext, nst)
\item lack of expected features (str, stp, nm3)
\item problem with homology search step (bd5, bd3, nop)
...
\item lack of single origin sequence (ori)
\end{itemize}
